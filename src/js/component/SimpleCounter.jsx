    ...
    return (
        <>
            <div className='counter-display'>
                ...
                <div className="sec hundred-thousands">
                    {props.hundredThousandsDigit}
                </div>
                <div className="sec ten-thousands">
                    {props.tenThousandsDigit}
                </div>
                <div className="sec thousands">
                    {props.thousandsDigit}
                </div>
                <div className="sec hundreds">
                    {props.hundredsDigit}
                </div>
                <div className="sec tens">
                    {props.tensDigit}
                </div>
                <div className="sec ones">
                    {props.onesDigit}
                </div>
            </div>
        </>
